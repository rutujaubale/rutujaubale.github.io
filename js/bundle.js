...
},{"./components/App.react.js":159,"react":156}],158:[function(require,module,exports){
var React = require('react');
var DividerBlock = require('./DividerBlock.react.js');
var SectionHeader = require('./SectionHeader.react.js')

module.exports = About = React.createClass({displayName: "About",
  getInitialState: function(){
    return({
      "content":{
  ...
  componentDidMount: function(){
    ...
    $(this.refs["section"].getDOMNode()).css("background","rgba(255,255,255,1)");
  ...
  render: function(){
    ...
    React.createElement("div", {className: classes, ref: "section"},      
      React.createElement(SectionHeader, {iconName: "user", title: "About Me", ref: "sectionHeader"}), 
      React.createElement(DividerBlock, {quantity: "2"}), 
      React.createElement(Content, {self: this})    
    )
    );
  }
})
...
Content = React.createClass({displayName: "Content",
  render: function(){
    ...
    return(
      React.createElement("div", {className: "ui text container center aligned basic segment " + additionalClasses},    
    ...
    return({
      "content":{
        ...
        "segment_content": "<ol> \
                    ...
                    <li> <u>Rutuja Ubale</u>, Yao Qian, and Keelan Evanini, &quot;<font color=\"purple\"><b>Exploring end-to-end attention-based neural networks for native language identification.</b></font>&quot; in <i>Proceedings of the IEEE Workshop on Spoken Language Technology (SLT 2018)</i>, pp. 84-91, Athens, Greece, December, 2018. IEEE.</li>\
                    <a href=\"./papers/slt2018-nli.pdf\" style=\"color:#F54C77\">[pdf]</a> <a href=\"./papers/slt2018-nli-poster.pdf\" style=\"color:#F54C77\">[poster]</a> \
                    </br>\
                    <li>Yao Qian, <u>Rutuja Ubale</u>, Matthew Mulholland, Keelan Evanini, and Xinhao Wang, &quot;<font color=\"purple\"><b>A prompt-aware neural network approach to content-based scoring of non-native spontaneous speech.</b></font>&quot; in <i>Proceedings of the IEEE Workshop on Spoken Language Technology (SLT 2018)</i>, pp. 979-986, Athens, Greece, December, 2018. IEEE.</li> \
                    <a href=\"./papers/slt2018-content_scoring.pdf\" style=\"color:#F54C77\">[pdf]</a> <a href=\"./papers/slt2018_content_scoring-poster.pdf\" style=\"color:#F54C77\">[poster]</a>\
                    </br>\
                    <li>Yao Qian, <u>Rutuja Ubale</u>, Patrick Lange, and Keelan Evanini, &quot;<font color=\"purple\"><b>From Speech Signals to Semantics - Tagging Performance at Acoustic, Phonetic and Word Levels.</b></font>&quot; in <i>Proceedings of the 11th International Symposium on Chinese Spoken Language Processing (ISCSLP 2018)</i>, Taipei, Taiwan, November, 2018. IEEE.</li> \
                    <a href=\"./papers/iscslp2018-slu.pdf\" style=\"color:#F54C77\">[pdf]</a> \
                    </br>\
                    <li>Zhaoheng Ni, <u>Rutuja Ubale</u>, Yao Qian, Michael Mandel, Su-Youn Yoon, Abhinav Misra, and David Suendermann-Oeft, &quot;<font color=\"purple\"><b>Unusable Spoken Response Detection with BLSTM Neural Networks.</b></font>&quot; in <i>Proceedings of the 11th International Symposium on Chinese Spoken Language Processing (ISCSLP 2018)</i>, Taipei, Taiwan, November, 2018. IEEE.</li> \
                    ...
                    <a href=\"./papers/las2018-steam.pdf\" style=\"color:#F54C77\">[pdf]</a> <a href=\"https://dl.acm.org/citation.cfm?id=3231681\" style=\"color:#F54C77\">[acm]</a> <a href=\"./papers/las2018-leong-poster.pdf\" style=\"color:#F54C77\">[poster]</a>\
                    </br>\
...
module.exports = Experience = React.createClass({displayName: "Education and Experience",
  getInitialState: function(){
    return({
      "content": {
        "ets-present":{
        ...
        "ucla-cntd":{
          "segment_content": "Advisor: Prof. Dr. Abeer Alwan (Speech Processing and Auditory Perception Laboratory) <br/> <br/> Coursework - <br/> <ul style=\"list-style-type:disc; font-size:95%;\"> <li>Statistics Programming (STAT202A) </li> <li>Linear Programming (EE236A)</li> <li>Matrix Analysis for Scientists and Engineers (EE205A)</li> <li>Digital Speech Processing (EE214A)</li> <li>Big Data: Modeling and Mining the Web (EE239AS)</li> <li>Language and Thought (NLP) (CS263A)</li> <li>Current Topics in Data Structures: Data Science (CS249)</li> <li>Advanced Topics in Speech Processing (EE214B)</li> <li>Graphs and Network Flows (EE232E)</li> </ul> </br> Activities and memberships: ISCA member, UCLA Anderson Behavioral Lab, UCLA Recreation: Dance",
          "image_url":  "./images/ucla-circular-logo.png",  
          "companyName": " <p style=\"color:#0A8BD9;\"> University of California, Los Angeles (UCLA) </p>",
          "industry": "<p style=\"color:#F5C904;\"> Master of Science (M.S.), Electrical Engineering </p>",
          "companyDescription": "",
          "jobTitle": "Second year of MS Degree finishing in December 2016.",
          "timeline": "September 2016 - December 2016 <br/> Los Angeles, CA",
          "jobDescription": "",
        },
        "yfrs":{
          "segment_content": "Scholarship recipient, selected to participate at the workshop for women undergraduate and masters students working in speech science and technology at the Interspeech 2016 conference in San Francisco. Presentation on my project “Drunk-Text Detection” at the workshop’s poster session.",
          "image_url":  "./images/is2016.jpg",  
          "companyName": "<p style=\"color:#DC3615;\">YFRSW Scholarship at Interspeech 2016</p>",
          "industry": "<p style=\"color:#0A99F0;\"> Workshop for Young Female Researchers in Speech Science & Technology</p>",
          "companyDescription": "",
          "jobTitle": "Funded by NSF, Microsoft & Google.",
          "timeline": "September 2016 <br/> San Francisco, CA",
          "jobDescription": "",
        },
        "ets-intern":{
          "segment_content": "Worked with Prof. Dr. David Suendermann-Oeft and Yao Qian on the Spoken Language Understanding (SLU) Component in the HALEF dialog system. Designed and implemented the SLU system based on statistical classification of textual features such as Bag of Words, TF-IDF, N-gram collocations. Measured performance of current and implemented versions of SLU in terms of concept and latency for real-time implementation. Implemented and connected a scalable version of the SLU as a back-end web service that can be queried in VXML for dialog management. Performed analysis for tracking and quantifying uncertainty in dialog state by confidence scoring. Designed an SLU system based on paragraph vectors and word embedding vectors as a future consideration to the implemented system.", 
          "image_url":  "./images/3b472e9.png",
          "companyName": "<p style=\"color:#052F83;\">Educational Testing Service (ETS) </p>",
          "industry": "<p style=\"color:#9E1C01;\"> Dialog, Multimodal, and Speech Research Center (DIAMONDS)</p>",
          "companyDescription": "",
          "jobTitle": " Natural Language Processing Consultant (Internship)",
          "timeline": "June 2016 - September 2016 <br/> San Francisco Bay Area, California ",
          "jobDescription": "",
        },
        "ucla-start":{
          "segment_content": "Advised by Prof. Dr. Abeer Alwan and worked with her research group - <a href='http://www.seas.ucla.edu/spapl/index.html'>Speeech Processing and Auditory Perception Laboratory (SPAPL) </a>. <br/> Pursuing studies in the Signals and Systems track of the Electrical Engineering Dept. with focus on Machine Learning, Data Science, Natural Language Processing and Speech Processing.",  
          "image_url":  "./images/ucla-circular-logo.png",
          "companyName": "<p style=\"color:#0A8BD9;\"> University of California, Los Angeles (UCLA) </p>",
          "industry": "<p style=\"color:#F5C904;\"> Master of Science (M.S.), Electrical Engineering </p>",
          "companyDescription": "",
          "jobTitle": "First Year of M.S. Degree",
          "timeline": "September 2015 - June 2015 <br/> Los Angeles, CA",
          "jobDescription": "",
        },
        "vit":{
          "segment_content": "Ranked 3rd in the Electronics Engineering undergraduate program of 111 students. Completed 172 units of undergraduate coursework with specializations in Digital Image Processing, Pattern Recognition and Biomedical Electronics. In addition, completed 20 units of Honors coursework in VLSI Design which is taught from the fourth semester to the eighth semester of the undergraduate program as a mélange of theoretical and experimental learning. <p> Undergraduate Thesis: <i>Accent Correction System Based On Feedback Stimuli Generation For Non Native English Speakers</i></p> <p>Societies and Memberships: The Robotics Forum (TRF-VIT), IEEE Student member (since 2011)</p>",
          "image_url":  "./images/vit_logo.png",  
          "companyName": "<p style=\"color:#2471A3;\">Vishwakarma Institute of Technology </p>",
          "industry": "<p style=\"color:#DC3615;\">Bachelor of Technology (B.Tech.), Electronics Engineering with Honors in VLSI Design - First Class with Distinction</p>",
          "companyDescription": "",
          "jobTitle": "Undergraduate Studies",
          "timeline": "July 2011 - May 2015 <br/> Pune, Maharashtra, India",
          "jobDescription": "",
        },
        "hsc-scholar":{
          "segment_content": "",
          "image_url":  "./images/pmc.jpg",  
          "companyName": "<p style=\"color:#FE8B00;\">Lokshahir Annabhau Sathe Scholarship</p>",
          "industry": "<p style=\"color:#8D3421;\">Funded by Pune Municipal Corporation</p>",
          "companyDescription": "",
          "jobTitle": "Scholarship for academic excellence in Higher Secondary School Certificate (HSC) exam.",
          "timeline": "August 2011 <br/> Pune, Maharashtra, India",
          "jobDescription": "",
        },
        "fergusson":{
          "segment_content": "11th and 12th grade (high school) with focus on Science. Studied French as second language. <p>Received a scholarship from the Pune Municipal Corporation for securing a First Class with Distinction at the Higher Secondary School Certificate Examination.</p>",
          "image_url":  "./images/fc_logo.jpg", 
          "companyName": "<p style=\"color:#2471A3;\">Fergusson College, Pune</p>",
          "industry": "High School/ Junior College",
          "companyDescription": "",
          "jobTitle": "Higher Secondary School Certificate (HSC) - First Class with Distinction",
          "timeline": "July 2009 - May 2011 <br/> Pune, Maharashtra, India",
          "jobDescription": "",
        },
        "ssc-scholar":{
          "segment_content": "",
          "image_url":  "./images/pmc.jpg",  
          "companyName": "<p style=\"color:#63CA36;\">Bharat Ratna Maulana Abul Kalam Azad Scholarship</p>",
          "industry": "<p style=\"color:#44D3CD;\">Funded by Pune Municipal Corporation</p>",
          "companyDescription": "",
          "jobTitle": "Scholarship for academic excellence in Secondary School Certificate (SSC) exam.",
          "timeline": "August 2009 <br/> Pune, Maharashtra, India",
          "jobDescription": "",
        },
        "annes":{
          ...
          "timeline": "June 1997 - March 2009 <br/> Pune, Maharashtra, India",
          "jobDescription": "",
        },      
      }
    });
  ...
  componentDidMount: function(){    
    $(this.refs["section"].getDOMNode()).css("background","#FF7D75");
    $('.jobDescription').css("padding-left","20px");
    $('.jobDescription').css("padding-top","5px");
    $('.cd-container').css("padding-bottom","100px");
  ...
  function showBlocks(blocks, offset) {
    ...
    // $('div',$(this.refs["section"].getDOMNode())).css("color","white");
    // $('.segment',$(this.refs["section"].getDOMNode())).css("color","black");
    // $(this.refs["sectionHeader"].refs["titleHeader"].getDOMNode()).css("color","white");
  },
  render: function(){
    classes = "ui"
    // <SectionHeader iconName="building" title="Experience" ref="sectionHeader"/>
    //  <DividerBlock quantity="2"/>
    //  <ExperienceContent self={this}/>  
    return(     
    React.createElement("div", {className: classes, ref: "section"},  
      React.createElement("div", {className: "ui container"},               
        React.createElement(SectionHeader, {iconName: "student", title: "Education and Experience", ref: "sectionHeader"}), 
        React.createElement(Timeline, {self: this}), 
        React.createElement(DividerBlock, {quantity: "2"})
      )
    )
    );
...
Timeline = React.createClass({displayName: "Timeline",
  render: function(){
    ...
    return(
      React.createElement("div", {id: "cd-timeline", className: "cd-container"}, 
        React.createElement(DividerBlock, {quantity: "1"}), 
        markup        
      )     
    )
...
TimelineElement = React.createClass({displayName: "TimelineElement",  
  render: function(){
    var content = this.props.self.state.content[this.props.contentKey];
    return(
      React.createElement("div", {className: "cd-timeline-block"},  
        React.createElement(TimelineElementImage, {image_url: content.image_url}), 
        React.createElement(TimelineElementContent, {content: content})
      )
    )
  }
})

TimelineElementImage = React.createClass({displayName: "TimelineElementImage",
  render: function(){
    var image_url = this.props.image_url;
    return(
      React.createElement("div", {className: "cd-timeline-img cd-picture"}, 
        React.createElement("img", {className: "ui circular image big work-image", src: image_url, alt: "Picture"})
      ) 
    )
  }
})

TimelineElementContent = React.createClass({displayName: "TimelineElementContent",
  render: function(){
    var content = this.props.content;
    return(
      React.createElement("div", {className: "cd-timeline-content"}, 
        React.createElement("div", {className: "ui content right aligned"}, 
          React.createElement("div", {className: "header", dangerouslySetInnerHTML: {__html: content.companyName}}
            ), 
          React.createElement("div", {className: "meta"}, 
            React.createElement("div", {dangerouslySetInnerHTML: {__html: content.industry}})
          ), React.createElement("br", null),           
          React.createElement("div", {className: "header", dangerouslySetInnerHTML: {__html: content.jobTitle}}), React.createElement("br", null), 
          React.createElement("div", {className: "description"}, 
            React.createElement("p", {dangerouslySetInnerHTML: {__html: content.segment_content}})
          )         
        ),        
         React.createElement("span", {className: "cd-date", dangerouslySetInnerHTML: {__html: content.timeline}})
      ) 
    )
  }
})

},{"./DividerBlock.react.js":161,"./SectionHeader.react.js":169,"react":156}],163:[function(require,module,exports){
var React = require('react');
var DividerBlock = require('./DividerBlock.react.js');
    ...
    return( 
      React.createElement("div", {className: classes, ref: "footerSection"},        
        React.createElement("div", {className: "ui text container center aligned"}, 
          ...
          React.createElement("p", null, "Built with ", React.createElement("a", {style: {color: "#ff6a56", href: "https://nodejs.org/en/"}}, "NodeJS"), ", ", React.createElement("a", {style: {color: "#ff6a56", href: "https://facebook.github.io/react/index.html"}}, "ReactJS"), " and ", React.createElement("a", {style: {color: "#ff6a56", href: "http://semantic-ui.com/"}}, "SemanticUI")), 
          ...
          React.createElement("p", null, "© 2016 Rutuja Ubale", React.createElement("br", null), "San Francisco, CA"), 
          React.createElement(DividerBlock, {quantity: "2"})
        )       
      )
    );
...
},{"./DividerBlock.react.js":161,"react":156}],164:[function(require,module,exports){
var React = require('react');
var DividerBlock = require('./DividerBlock.react.js')
var content={
  ...
  "profileHeaderButtons":[
      ...
      "url": "https://scholar.google.com/citations?user=oN5mT3MAAAAJ&hl=en",
      "icon": "student",
      "color": "blue"
    },
    {
    ...
    {
      "title": "Github",
      "url": "http://github.com/RutujaUbale",
      "icon": "github",
      "color": "green"
    }
  ]
...
module.exports = Home = React.createClass({displayName: "Home",
  componentDidMount: function(){
    $(document).ready(function(){
      ...
      //  duration   : '3s'
      // });  
      $('div,h1',$('.descriptionBlock')).css('color','#000000');
      $('a',$('.descriptionBlock')).css('color','#faebd7');
      $('.jumbotron').css('position','fixed') 
      $('.profileImage').css('height','300px')  
      $('.profileImage').css('width','300px') 
    })
  },
  render: function(){
    classes = "ui "+ this.props.className ? this.props.className : ""
    return(       
      React.createElement("div", {className: classes}, 
        React.createElement("div", {className: "ui centered image jumbotron"}), 
        React.createElement(DividerBlock, {quantity: "4"}),       
...
DescriptionBlock = React.createClass({displayName: "DescriptionBlock",
  render: function(){
    return(
      React.createElement("div", {className: "ui text container center aligned descriptionBlock"},                  
        React.createElement("h1", {dangerouslySetInnerHTML: {__html: content.greeting}}),                   
        React.createElement("div", {className: "ui hidden divider"}), 
        React.createElement("div", {className: "ui horizontal divider"}, 
          React.createElement("p", {className: "ui label teal "}, 
            content.profileSummary.toUpperCase()
          ) 
        ), 
        React.createElement("div", {className: "ui hidden divider"}), 
        React.createElement("div", {className: "ui"}, 
          React.createElement("p", {className: "ui", dangerouslySetInnerHTML: {__html: content.introduction}}), 
          React.createElement(DividerBlock, {quantity: "2"}), 
          React.createElement("div", {className: "ui centered three column very relaxed grid"}, 
            
              content.profileHeaderButtons.map(function(item){
                var iconClasses = "ui large icon" + String(" ") + item.icon
                var anchorClasses = "ui label basic" + String(" ") + item.color
                var url = item.url;
                return(
                  React.createElement("div", {key: item.title}, 
                    React.createElement("div", {className: "column"}, 
                      React.createElement("a", {href: url, className: anchorClasses, target: "_blank"}, 
          ...
          React.createElement(DividerBlock, {quantity: "3"})
        )       
      ) 
    )
  }
...
ProfileCard = React.createClass({displayName: "ProfileCard",
  render: function(){
    return(   
      React.createElement("div", null, 
        React.createElement("div", {className: "ui centered medium circular image centered card profileCard"}, 
          React.createElement("img", {className: "profileImage", src: content.profileURL})
        ),        
        React.createElement("div", {className: "ui hidden divider"})
        )
    );
...
CompactMenu = React.createClass({displayName: "CompactMenu",
  render: function(){
    return(
      React.createElement("div", {className: "ui content"}, 
        React.createElement("a", {className: "header"}, content.profileName), 
        React.createElement("div", {className: "meta"}, 
          React.createElement("span", {className: "date"}, content.profileDescription)
        )
      )      
    );
  }
...
},{"./DividerBlock.react.js":161,"react":156}],165:[function(require,module,exports){
var React = require('react')
var menuItems = [
  ...
  // {'iconName': 'newspaper','header': 'Blog', 'id':'id_blog', 'url':"./blog", 'newTab': true},
];

var socialIcons = [
  {"site":"facebook","url":"https://www.facebook.com/rutuja.ubale"},
  {"site":"linkedin","url":"https://www.linkedin.com/in/rutujaubale"},
  {"site":"flickr","url":"https://www.flickr.com/photos/rutujaubale/"}
];

module.exports = Menu = React.createClass({displayName: "Menu",  
  getInitialState: function(){
    return({
      isMobile: false
    })        
  ...
  setStyle: function(){
    $('.mainMenu').css('border',"0px"); 
    $('.leftMenu').css('background',"rgba(255, 255, 255, 0)");
    $('.rightMenu').css('background',"rgba(255, 255, 255, 0)");

    var colorRatio = $(document).scrollTop() / 100 < 1.0 ? $(document).scrollTop() / 100 : 1.0;
    var menuFontColorValue = Math.round(255*(1-colorRatio));
    $('.menuItem').css('color',"rgb("+menuFontColorValue+","+menuFontColorValue+","+menuFontColorValue+")");  

    if(!this.state.isMobile){
      $(document).on('scroll', function (e) {
          var scrollRatio = $(document).scrollTop() / 500 < 1.0 ? $(document).scrollTop() / 500 : 1.0;
          var colorRatio = $(document).scrollTop() / 100 < 1.0 ? $(document).scrollTop() / 100 : 1.0;
          var menuFontColorValue = Math.round(255*(1-colorRatio));
          $('.mainMenu').css('background',"rgba(255, 255, 255, "+scrollRatio+")");        
          $('.menuItem').css('color',"rgb("+menuFontColorValue+","+menuFontColorValue+","+menuFontColorValue+")");
      });    
    }
  },
  render: function(){  
    return(   
      React.createElement("div", {className: "ui sticky"}, 
          React.createElement("div", {className: "ui centered grid conatiner"}, 
            React.createElement("div", {className: "sixteen wide column"}, 
              React.createElement("div", {className: "ui top attached secondary pointing borderless menu mainMenu"}, 
                React.createElement(LeftMenu, {menuItems: menuItems, scrollToSection: this.props.scrollToSection, ref: "ref_left_menu"}), 
                React.createElement(RightMenu, {ref: "ref_right_menu"})
              )
            )
          )
        )       
...
LeftMenu = React.createClass({displayName: "LeftMenu",
  componentDidMount: function(){    
    $('.menu').css('background',"rgba(255, 255, 255, "+$(document).scrollTop() / 500+")");    
  },
  getInitialState: function(){
    return({
      selectedSectionId: 'id_home',
    })        
  }, 
  handleClick: function(e){
    if(e.target.item.url.indexOf("#")!=-1){
      e.preventDefault();        
      this.props.scrollToSection(e.target.item);
    }
  },
  render: function(){
    return(
      React.createElement("div", {className: "left red menu leftMenu "}, 
                    
            this.props.menuItems.map(function(item,i){
              var active = false;
              if(item.id == this.state.selectedSectionId){
                active = true;
              }
              return(
                React.createElement(MenuItem, {item: item, key: item.id, active: active, handleClick: this.handleClick})  
              )
            }.bind(this))
...
MenuItem = React.createClass({displayName: "MenuItem",  
  handleChildClick: function(e){
    e.target.item = this.props.item
    this.props.handleClick(e)
  },
  render: function(){
    var iconClassName = this.props.item.iconName + " icon";
    var classes = "red borderless item menuItem " + (this.props.active?"active":"");    
    var htmlComponent = React.createElement("a", {href: this.props.item.url, className: classes, onClick: this.handleChildClick, target: this.props.newTab?"_new":"_blank"}, React.createElement("i", {className: iconClassName}), this.props.item.header)
    return(        
      htmlComponent
    )
  }
...
RightMenu = React.createClass({displayName: "RightMenu",
  render: function(){    
    return(
      React.createElement("div", {className: "right menu rightMenu"}, 
        React.createElement("div", {className: "ui right aligned category"}, 
          React.createElement("div", {className: "ui transparent icon input"}, 
          
            socialIcons.map(function(item){
              return(
                React.createElement(SocialLink, {item: item, key: "social_"+item.site})
              )
            })
...
SocialLink = React.createClass({displayName: "SocialLink",
  render: function(){
    var className = this.props.item.site + " icon";
    return(
      React.createElement("a", {href: this.props.item.url, target: "_blank", className: "item menuItem"}, 
...
module.exports = MobileMenu = React.createClass({displayName: "MobileMenu",
  componentDidMount: function(){
    $('.accordion')
      .accordion({   
        trigger: '.canToggleAccordian'  
      });
    $('.accordion').css('width','100%')
    $('.accordion').css('padding','10px 0px 20px 20px')
    $('.accordion .content').css('text-align','center')
  },
  getInitialState: function(){
    return({
      selectedSectionId: 'id_home',
  ...
  render: function(){
    var menuItemHTML = [];
      for(i in menuItems){
        ...
        menuItemHTML.push(
          React.createElement(MobileMenuItem, {item: item, key: item.id, active: active, handleClick: this.handleClick})  
        )
      }
    return(     
        React.createElement("div", {className: "ui inverted accordion"}, 
          React.createElement("div", {className: "title canToggleAccordian"}, 
            React.createElement("i", {className: "large sidebar down icon"})
          ), 
          React.createElement("div", {className: "content"}, 
            React.createElement("div", {className: "transition hidden ui centered large inverted link list"}, 
              menuItemHTML
            )
          )
        )
...
MobileMenuItem = React.createClass({displayName: "MobileMenuItem",  
  handleChildClick: function(e){
    e.target.item = this.props.item
    this.props.handleClick(e)
  },
  render: function(){
    var iconClassName = this.props.item.iconName + " icon";
    var classes = "item mobileMenuItem canToggleAccordian" //+ (this.props.active?"active":"");    
    var htmlComponent = React.createElement("a", {href: "#", className: classes, onClick: this.handleChildClick}, this.props.item.header)
    return(        
      htmlComponent
    )
  }
...
var myactivityContent = {
  "youtube":{
    "quote": "Some random quote...",
    "segment_content": "I have an active interest in photography. I enjoy travelling and clicking pictures.",
    "url": "./images/Flickr-collage.jpg",
    "image_url":  "",
    "title": "Photography",
  },
  "research":{
    "quote": "Some random quote...",
    "segment_content": "At UCLA, I work with the Speech Processing and Auditory Perception Lab (SPAPL) on Speaker Identification and Speech Synthesis. On the left, is a picture of the SPAPL team members at the Thanksgiving dinner hosted by Prof. Alwan and her family. The photo on the right is of the Dialog, Multimodal and Speech (DIAMONDS) group at ETS Research in San Francisco. I interned with the team this summer, where I designed Statistical Spoken Language Understanding models.",
    "url": "./images/Collage3.jpg",
    "image_url":  "./images/IconCollage2.jpg",
    "title": "Research Teams"
  },  
  "yfrsint":{
    "quote": "Some random quote...",
    "segment_content": "I was selected to participate and present my project in the Workshop for Young Female Researchers in Speech Science and Technology held at Google during Interspeech 2016. The workshop included panel discussions with current PhD students and senior researchers in the field, student poster presentations, mentoring and networking sessions.",
    "url": "./images/YFRS3.jpg",
    "image_url":  "./images/ISCA.png",
    "title": "Interspeech 2016"
  }, 
}

module.exports = MyActivity = React.createClass({displayName: "Activity",
  componentDidMount: function(){
    $('.menuItem').transition({
      animation  : 'fade in',
      duration   : '0.5s'
    });   
    // $(this.refs["section"].getDOMNode()).css("background","rgba(231,76,60,0.8)");
    // $(this.refs["section"].getDOMNode()).css("background","#e8edec");
    $(this.refs["section"].getDOMNode()).css("background","#f8eee7");   
    $(this.refs["sectionHeader"].refs["titleHeader"].getDOMNode()).css("color","black");    
  },
  render: function(){
    classes = "ui "
    return( 
    React.createElement("div", {className: classes, ref: "section"},      
      React.createElement(SectionHeader, {iconName: "setting", title: "Activity", ref: "sectionHeader"}), 
      React.createElement(DividerBlock, {quantity: "2"}),  
      React.createElement(MyActivityContentLeft, {contentKey: "research", className: "orange"}), 
      React.createElement(DividerBlock, {quantity: "2"}),
      React.createElement(MyActivityContentRight, {contentKey: "yfrsint", className: "orange"}),     
      React.createElement(DividerBlock, {quantity: "2"}),
      React.createElement(MyActivityContentLeft, {contentKey: "youtube", className: "orange"}), 
      React.createElement(DividerBlock, {quantity: "2"})
...
MyActivityContentRight = React.createClass({displayName: "MyActivityContentRight",
  render: function(){
    var content = myactivityContent[this.props.contentKey]
    ...
    return(
      React.createElement("div", {className: "ui container center aligned raised segment " + additionalClasses},    
          ...
          React.createElement("div", {className: "ui two column stackable grid"}, 
            React.createElement("div", {className: "column"},           
            React.createElement("h2", null, title), 
            React.createElement("img", {className: "ui centered big image", src: image_url}), 
            React.createElement("div", {className: "ui left aligned basic segment"}, 
              segment_content
              )
          ),  
            React.createElement("div", {className: "column"}, 
            React.createElement("img", {className: "ui centered big image", src: url})
          )                            
        )
      )
    );
...
MyActivityContentLeft = React.createClass({displayName: "MyActivityContentLeft",
  render: function(){
    var content = myactivityContent[this.props.contentKey]
    var quote = content.quote;
    var segment_content = content.segment_content;
    ...
    return(
      React.createElement("div", {className: "ui container center aligned raised segment " + additionalClasses},    
          ...
          React.createElement("div", {className: "ui two column stackable grid"}, 
            ...
            React.createElement("div", {className: "column"},           
            React.createElement("h2", null, title), 
            React.createElement("img", {className: "ui centered medium image", src: image_url}), 
            React.createElement("div", {className: "ui left aligned basic segment"}, 
              segment_content
              )
          )                                         
...
},{"./DividerBlock.react.js":161,"./SectionHeader.react.js":169,"react":156}],168:[function(require,module,exports){
var React = require('react');
var DividerBlock = require('./DividerBlock.react.js');
var SectionHeader = require('./SectionHeader.react.js')

module.exports = Projects = React.createClass({displayName: "Projects",
  getInitialState: function(){
    return(
      {
        "projects": [
          {
            "title": "SETU: Statistical Engine for Text Understanding in HALEF spoken dialog system",
            "institution": "Educational Testing Service Research",
            "timeline": "(2016)",
            "project_description": "Designed and implemented a Spoken Language Understanding web service that interprets the meaning in user's speech utterances using statistical classification techniques.<br/><br/>[Python, Flask, SKLL, WEKA, Scikit-learn, Gensim, NLTK, Matplotlib, Graphviz, Pandas, Numpy]", 
            "image_url":  "./images/slu-x.png",
            "industry": "Natural Language Processing",
            "url": ""
          },
          {
            "title": "Automatic Drunk Text-Detection",
            "institution": "University of California, Los Angeles",
            "timeline": "(2016)",
            "project_description": "Given a Tweet, the goal is to identify if it was written under the influence of alcohol or not. Performed text-based analysis to determine level of inebriation. Multiclass Support Vector Machine (SVM) classifier is trained using stylistic, LDA and n-gram features to detect drunk tweets.<br/><br/>[Python, Scikit-learn, PyEnchant, NLTK, Tweepy, Re, Pandas, Numpy]",
            "image_url":  "./images/Drunk-Text-Detect.png",
            "industry": "Computer Science",
            "url": ""
          },  
          {
            "title": "Noise Robust System for Automatic Speaker Identification",
            "institution": "University of California, Los Angeles",
            "timeline": "(2016)",
            "project_description": "Automatic speaker identification (SID) is a task to recognize a speaker among a group of known speakers. For example, the system builds statistical models of the speakers with training data, and determines which one of the speaker models best matches the test utterance. In this project, the test utterances are degraded by additive noise. Common SID systems usually have significant performance degradation in the presence of noise. Having explored several noise-robust features, filtering techniques and classifiers we have designed an algorithm using the best performing features and filters that recognizes the speaker from recordings with additive noise.<br/><br/>[MATLAB, VoiceBox, VoiceSauce]", 
            "image_url":  "./images/speaker-id2.png",
            "industry": "Computer Science",
            "url": ""
          },    
          {
            "title": "Acoustic correlates to speaker identity",
            "institution": "University of California, Los Angeles",
            "timeline": "<br/>(2016)",
            "project_description": "In this project, we utilize a fresh database and examine the information provided by various acoustic features in speaker identification. We perform exper- iments to calculate perceptual similarity or dis-similarity be- tween speakers and also study various acoustic features and classifiers to determine within-speaker and cross-speaker vari- ability. Through our experiments we realized that widely-used features such as linear predictive coding (LPC) coefficients, Mel frequency cepstral coefficients (MFCCs), etc. are not robust in presence of voice quality change. However, they can be combined together to provide better performance as they carry some complementary information.<br/><br/>[MATLAB, VoiceSauce]",  
            "image_url":  "./images/face.png",
            "industry": "Computer Science",
            "url": ""
          },
          {
            ...
            "institution": "University of California, Los Angeles",
            "timeline": "<br/>(2016)",
            "project_description": "Analyzed the social and interest graph of friendship network using Facebook and Google plus edge list. Identified important people using core nodes, and analyzed people having strong social ties using graph partitioning. Found the community structure i.e the friends circle and interest group in the graph network using fast-greedy, edge-betweenness and infomap. Analyzed the community structure of nodes with high embeddedness and dispersion </br></br>[R, igraph]",  
            "image_url":  "./images/graph2.png",
            "industry": "Computer Science",
            "url": ""
          },
          
          {
            "title": "Movie Rating Prediction via IMDb Database Exploration",
            "institution": "University of California, Los Angeles",
            "timeline": "(2016)",
            "project_description": "Built a movie graph network on the IMDB dataset with weights as jaccard indices. Identified the top ranking actors using Page Rank. Predicted the genre of new upcoming movies using features like pagerank, year, director and actors. Predicted the rating of new upcoming movies using a regression model. <br/><br/>[Python, R, igraph]", 
            "image_url":  "./images/imdb-project.png",
            "industry": "Computer Science",
            "url": ""
          },
          {
            ...
            "institution": "University of California, Los Angeles",
            "timeline": "<br/>(2016)",
            "project_description": "Built a recommendation system for movies using the Alternating Least Squares factorization algorithm on the ‘MovieLens’ dataset.<br/><br/>[MATLAB]",  
            "image_url":  "./images/als.png",
            "industry": "Computer Science",
            "url": ""
          },
          {
            ...
            "timeline": "(2015)<br/><br/>",
            "project_description": "The purpose of this project was to access the Twitter Application Programming Interface(API), estimate the public's perception (the sentiment) of a particular term or phrase and analyze the relationship between location and mood based on a sample of twitter data. Computed the sentiment of each tweet based on the sentiment scores of the terms in the tweet, determined the sentiment of new terms and calculated the frequency of each term in the livestream data. Analysed twitter data to find the happiest state in USA using sentiment analysis by building the sentiment dictionary with positive and negative sentiment terms. Computed the ten most frequently occurring hashtags from the data that was gathered.",  
            "image_url":  "./images/social_sentiment.png",
            "industry": "Computer Science",
            "url": ""
          },
          
          {
            "title": "Identifying patterns of brain activity in larval zebrafish",
            "institution": "Independent",
            "timeline": "(2015)<br/>",
            "project_description": "Implemented distributed Principal Component Analysis to identify patterns across time-varying images. <br/><br/>[Python, MLlib]", 
            "image_url":  "./images/zebra_pca.png",
            "industry": "Computer Science",
            "url": "#"
          },
          {
            "title": "Accent Correction System Based On Feedback Stimuli Generation For Non Native English Speaker",
            "institution": "Vishwakarma Institute of Technology",
            "timeline": "(2015)<br/><br/><br/>",
            "project_description": "Developed an accent correction system in which non-native English speaker's speech is corrected by identifying deviations in the person's current speech from the desired accent such as pronunciation, speech patterns, and speech habits or the change in one's pronunciation. We focus on commanding the prosodic features of the speech signal through a transformation system built on the PSOLA algorithm and dynamically modifying the transformation parameters using Regression. The algorithm will be implemented using MATLAB on a database of utterances derived from native Marathi speakers who are learning to produce an American English accent.", 
            "image_url":  "./images/Accent.png",
            "industry": "Computer Science",
            "url": ""
          },                
        ]
  ...
  componentDidMount: function(){
    $(this.refs["section"].getDOMNode()).css("background","rgba(42,48,58,1)");
    $(this.refs["section"].getDOMNode()).css("background","#192231");   
    $(this.refs["section"].getDOMNode()).css("color","#BBBBBB");
    $('a',$(this.refs["section"].getDOMNode())).css("color","#999999");
    $(this.refs["sectionHeader"].refs["titleHeader"].getDOMNode()).css("color","#BBBBBB");
    $('.hoverProjectContent').css("padding","20px");
    $('.hoverProjectContent').css("line-height","150%");
    $('.dimmer').css("overflow","scroll");
  },
  render: function(){
    classes = "ui "
    return( 
    React.createElement("div", {className: classes, ref: "section"},      
      React.createElement(SectionHeader, {iconName: "flask", title: "Projects", ref: "sectionHeader"}), 
      React.createElement(ProjectContent, {self: this}),  
      React.createElement(DividerBlock, {quantity: "2"}),   
...
ProjectContent = React.createClass({displayName: "ProjectContent",
  getInitialState:function(){
    return({
      numberOfProjectColumns: "four"
    })
  },
  componentDidMount: function(){
    ...
    $(window).resize(this.setNumberOfColumns)
  },
  setNumberOfColumns: function(){
    var k = $(window).width()/768;
    var numberOfColumns = ""
    if(k > 1){
    ...
    else if(0.60 <= k && k< 0.80){
      numberOfColumns = "two"
    }
    else if(k < 0.6){
      numberOfColumns = "one"
    }
    // console.log(k+":"+numberOfColumns+" columns");
    if(this.state.numberOfProjectColumns != numberOfColumns){
      this.setState({
        numberOfProjectColumns: numberOfColumns
      })
    }
  },
  render: function(){   
    var additionalClasses = this.props.className ? this.props.className : "";   
    var self = this.props.self;
    var markup = self.state.projects.map(function(item){
        return(
          React.createElement(Project, {content: item, self: self, key: item.title})
        ) 
      });
      var projectColumnStyling = "ui "+ this.state.numberOfProjectColumns +" special cards"
    return(
      React.createElement("div", {className: "ui container center aligned basic segment "},                     
          React.createElement("div", {className: projectColumnStyling}, 
            markup
          ) 
      )
    );
...
Project = React.createClass({displayName: "Project",
  render: function(){
    var project_content = this.props.content;
    return(
      React.createElement(ProjectProfileCard, {content: project_content})                         
    );
  }
})

ProjectProfileCard = React.createClass({displayName: "ProjectProfileCard",
  handleClick: function(event){
    ...
    render: function(){
      var content = this.props.content;
      return(         
          React.createElement("div", {className: "ui link card", onClick: this.handleClick}, 
            React.createElement("div", {className: "blurring dimmable image"}, 
              React.createElement("div", {className: "ui dimmer"}, 
                React.createElement("div", {className: "content"}, 
                  React.createElement("div", {className: "center"}, 
                    React.createElement("div", {className: "ui left aligned hoverProjectContent", dangerouslySetInnerHTML: {__html: content.project_description}})
                  )
                )
              ), 
              React.createElement("img", {src: content.image_url})
            ), 
            React.createElement("div", {className: "content"}, 
              React.createElement("a", {href: content.url, className: ""}, content.title), 
              React.createElement("div", {className: "meta"}, React.createElement("br", null), React.createElement("span", {className: "date", dangerouslySetInnerHTML: {__html: content.timeline}}))
            ), 
...
ProjectDescription = React.createClass({displayName: "ProjectDescription",
  render: function(){
    var content = this.props.content;
    return(   
          React.createElement("div", {className: "ui text container left aligned"}, 
        React.createElement("div", {className: "small header"}, content.jobTitle), 
        React.createElement("div", {className: "meta"}, React.createElement("a", null, content.timeline)), 
        React.createElement("div", {className: "description"}, React.createElement("p", {dangerouslySetInnerHTML: {__html: content.project_description}}))
      )
...
ModalPopup = React.createClass({displayName: "ModalPopup",
  render: function(){
    return(
      React.createElement("div", {className: "ui basic modal"}, 
        ...
        React.createElement("div", {className: "image content"}, 
          ...
          React.createElement("div", {className: "description"}, 
            React.createElement("p", null, "Your inbox is getting full, would you like us to enable automatic archiving of old messages?")
          )
        ), 
        React.createElement("div", {className: "actions"}, 
          React.createElement("div", {className: "two fluid ui inverted buttons"}, 
            React.createElement("div", {className: "ui cancel red basic inverted button"}, 
              React.createElement("i", {className: "remove icon"}), 
              "No"
            ), 
            React.createElement("div", {className: "ui ok green basic inverted button"}, 
...
},{"./DividerBlock.react.js":161,"./SectionHeader.react.js":169,"react":156}],169:[function(require,module,exports){
var React = require('react')

module.exports = SectionHeader = React.createClass({displayName: "SectionHeader",
  render: function(){
    return(
      React.createElement("div", {className: "ui center aligned text container"},     
        React.createElement("br", null),      
        React.createElement("h2", {className: "ui header", ref: "titleHeader"},           
          React.createElement("div", {className: "content"}, 
            React.createElement("i", {className: this.props.iconName+" icon"}), 
            this.props.title
          )
        )
      ) 
...
var MobileMenu = require('./MobileMenu.react.js')
var Home = require('./Home.react.js')
...
module.exports = SiteContainer = React.createClass({displayName: "SiteContainer",
  ...
  selectVisibleSection: function(selectedSectionId){
    if(!this.state.isMobile){
      if(this.refs["id_menu"].refs["ref_left_menu"].state.selectedSectionId != selectedSectionId){
        this.refs["id_menu"].refs["ref_left_menu"].setState({
  ...
  findCurrentVisibleSection: function(){        
    var documentPosition = $(document).scrollTop()    
    var padding = 100;
    for(i in ref_ids){
        var startPosition = $(this.refs[ref_ids[i]].getDOMNode()).position().top
      var endPosition = $(this.refs[ref_ids[i]].getDOMNode()).position().top + $(this.refs[ref_ids[i]].getDOMNode()).height()
        if(documentPosition > startPosition - padding && documentPosition < endPosition - padding){
          this.selectVisibleSection(ref_ids[i])
        }
      }           
  },
  componentDidMount: function(){      
    var self = this;
    $(document).on('scroll', function (e) {
      self.findCurrentVisibleSection();
      }); 
      this.setMobileOrDesktop();
      $(window).resize(function(){
        if($(window).width() < 768 && !self.state.isMobile){        
          self.setState({
            isMobile: true
          })
        }
        else if($(window).width() >= 768 && self.state.isMobile){        
          self.setState({
            isMobile: false
          })
        }
  ...
  scrollToSection:function(item){   
    var self = this;
    var element = this.refs[item.id].getDOMNode()
    $('html, body').animate({
          scrollTop: $(element).offset().top - 40
      }, 1000, function(){
        self.selectVisibleSection(item.id)
      });     
  },
  scrollToSectionMobile:function(item){   
    var self = this;
    var element = this.refs[item.id].getDOMNode()
    $('html, body').animate({
  ...
  render: function(){
    // These guys should have ids synced with the Menu items
    var menu = "";
    if(!this.state.isMobile){
      menu = React.createElement(Menu, {scrollToSection: this.scrollToSection, ref: "id_menu"})
    }
    else{
      menu = React.createElement(MobileMenu, {scrollToSection: this.scrollToSectionMobile})
    }
    return(
      React.createElement("div", null,  
        React.createElement("div", {className: "bkg"}),       
        menu, 
        React.createElement("div", {className: "content"},          
